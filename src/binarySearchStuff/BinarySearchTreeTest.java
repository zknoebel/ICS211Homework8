...
public class BinarySearchTreeTest {
	 ...
	 *
	 * The list, when added to a binary tree from 0 to N-1, will produce a
	 * balanced tree. The list is also in the same order a level-order traversal
	 * should produce.
	 *
	 * @param numItems
	...
	public void testAdd() {
		...
		/*
		 * Add the same elements again. The add method should return true for
