...
public interface SearchTree<E> {
	 ...
	 *
	 * The add method will replace an existing element if it contains the same
	 * "key" (i.e., the comparator says they're equal).
	 * 
	...
	/**
	 * @return a reference to the target if found, null if target isn't in the
	 *         tree.
	 */
	E find(E target);
